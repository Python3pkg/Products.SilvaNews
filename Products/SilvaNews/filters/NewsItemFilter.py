...
class NewsItemFilterBase(object):
    """Base class for news item filters.  This is not part of the 
       silva inheritance story, so that content objects can inherit the
       meaningful parts of NewsItemFilter and not be grokked as both 
       Content AND NonPublishable (i.e. AgendaCalendar)
    """
...
class NewsItemFilter(Filter, NewsItemFilterBase):
